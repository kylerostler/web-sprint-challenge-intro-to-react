...
React js is a library designed by facebook that is used to build UI that reacts to the user without having to refresh the page, it helps with updating so that it can compile the updates and not refresh the page everytime

1. Describe component state.

a component state is a function that builds and injects elements into the dom

1. Describe props.

props are bits of information passed from a parent component to it's children components

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

side effects are things that affect the scope outside of the function for example a network request pulls information from a third party that causes things to happen outside itself